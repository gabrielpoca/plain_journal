      ...
      render={({ handleSubmit, submitting, pristine }) => (
        ...
        >
          ...
          <Typography>
            ...
            this password in case you need it again. If you lose this password,
          ...
          {!!props.wrongPassword && (
            <Typography className={classes.p} color="error">
              The password you entered is not the same password that you entered
              initially. To move forward, you must enter the correct password.
            </Typography>
          )}
        </form>
      )}
